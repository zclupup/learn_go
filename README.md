...
| Lesson 40 | issue_api 综合实战 | `lesson40_issue_api_practice/` | ⬜ 下一课 |

**当前进度：已完成 Lesson 01–39。已掌握 Go 基础语法、分层架构、依赖注入、泛型、RWMutex、slog、jsonparser、JWT、TOML 配置、issue_api 全览、Kratos Gin 嵌套路由、逐层追踪完整请求链路、Wire 自动依赖注入，能独立阅读 issue_api 任意接口。**
